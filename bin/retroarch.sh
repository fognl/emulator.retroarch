...
LOG_FILE=$ADDON_FILES/retroarch-lastrun.log

systemctl stop xbmc.service
sleep 1
$ADDON_DIR/bin/retroarch -c $ADDON_FILES/config/retroarch.cfg $EXTRAFLAG -L $ADDON_CORES/$1_libretro.so "$2" > $LOG_FILE 2>&1
